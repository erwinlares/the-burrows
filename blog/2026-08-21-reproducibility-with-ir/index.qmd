...
- reproducibility
- announcement
description: A CLI tool that makes single R scripts and Quarto documents self-describing
  and reproducible, no Dockerfile required.
engine: markdown
---
